...
function createPlot(titleName, numberOfHouses) {
	...
	d3.json("../data/simulatedannealing/" + String(numberOfHouses) + 
		...
		document.getElementById("img").innerHTML = "<h2>Best neigbourhood ever found, found with formula temp_i = temp_i - 1 * coolingrate</h2>"
		+ "<img src = '../images/simulatedannealing" + String(numberOfHouses) + ".jpg'>";
